...
if __name__ == "__main__":
    ...
    print(f"[INFO] enable_vm={getattr(args, 'enable_vm', True)} | enable_mass_aware={getattr(args, 'enable_mass_aware', True)} | enable_edge_loss={getattr(args, 'enable_edge_loss', True)} | model_dir={args.model_path} | iteration={args.iteration}")
